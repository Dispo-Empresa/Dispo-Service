using AutoMapper;
using Dispo.Infra.Core.Application.Endpoints;
...
namespace Dispo.Infra.Core.Application.Services
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<SignInResponseModel> AuthenticateByEmailAndPassword(string email, string password)
        {
        ...
        public UserResponseModel CreateAccountAndUser(SignUpRequestModel signUpRequestDto)
        {
            ...
            using (var tc = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
                ...
                userDto = _mapper.Map<UserResponseModel>(createdUser);
            }
            return userDto;
        }
        ...
        public UserAccountResponseModel UpdateUserAccountInfo(UserAccountResponseModel userAccountModel)
        {
